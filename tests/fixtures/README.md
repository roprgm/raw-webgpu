...
`corrected.dng` has a mandatory stage-2 GainMap that halves its Bayer samples. Browser tests check the resulting RGB values and white-balance edits through the SDK compatibility path.
